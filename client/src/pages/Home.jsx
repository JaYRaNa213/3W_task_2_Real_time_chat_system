    ...
    <Box sx={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <Grid container spacing={3} justifyContent="center" mb={4}>
          <Grid item xs={12} sm={4}>
            <Card sx={{ p: 3, textAlign: "center", borderRadius: 2 }}>
              ...
              <Typography variant="h6" fontWeight="bold">Real-time Messaging</Typography>
          ...
          <Grid item xs={12} sm={4}>
            <Card sx={{ p: 3, textAlign: "center", borderRadius: 2 }}>
              ...
              <Typography variant="h6" fontWeight="bold">Multiple Rooms</Typography>
              <Typography variant="body2" color="text.secondary">
          ...
          <Grid item xs={12} sm={4}>
            <Card sx={{ p: 3, textAlign: "center", borderRadius: 2 }}>
              ...
              <Typography variant="h6" fontWeight="bold">Guest Access</Typography>
              <Typography variant="body2" color="text.secondary">
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={2} mb={3} alignItems="center">
          <Button variant="contained" color="primary" onClick={() => navigate("/login")} sx={{ minWidth: 150 }}>
            Login
          </Button>
          <Button variant="outlined" color="primary" onClick={() => navigate("/register")} sx={{ minWidth: 150 }}>
            Register
          </Button>
          <Button
            variant="contained"
